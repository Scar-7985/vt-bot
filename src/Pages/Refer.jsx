        ...
        <div className="card-body">
          <div className="p-1">
            ...
            <div className="mt-2 text-center">
              <Link
                to={`https://wa.me/?text=${encodeURIComponent(`Use this code ${isAuthenticated} on https://app.vtbot.trade/`)}`}
                target="_blank"
                type="button"
                className="btn btn-success col-6 rounded shadowed mr-1 mb-1"
              >
